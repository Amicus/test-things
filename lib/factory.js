...
Factory.prototype.collection = function(Collection, count) {
...
Factory.prototype.collectionFactory = function(Collection, count) {
  var that = this
  return { 
    generate: function(overrideCount) {
      if(typeof overrideCount === "undefined") {
        overrideCount = count
      }
      return that.collection(Collection, overrideCount)
    }
  }
}
...
Factory.prototype._generateFields = function(fields) {
  _(fields).each(function(value, name) {
    ...
    if(typeof value === "string") {
      ...
      value = value()
    } else if(typeof value.generate === "function") {
